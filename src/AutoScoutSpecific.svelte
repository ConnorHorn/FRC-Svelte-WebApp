<script>
    import {taxi} from "./stores";

    let taxiValue=$taxi;

    //adjusts the state of da taxi, true vs false
    function shiftTaxi(){
        taxiValue=!taxiValue;
        taxi.update(n=>!n);
    }
